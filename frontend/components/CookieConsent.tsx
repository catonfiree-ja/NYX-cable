...
export default function CookieConsent() {
  ...
  useEffect(() => {
    const accepted = localStorage.getItem('nyx-cookie-consent')
    if (!accepted) {
  ...
  const accept = () => {
    localStorage.setItem('nyx-cookie-consent', 'true')
    setVisible(false)
  }
  ...
  return (
    <div style={{
      ...
      <p style={{ color: '#e2e8f0', fontSize: '0.84rem', margin: 0, lineHeight: 1.5, maxWidth: 600 }}>
        ...
        <a href="/privacy-policy" style={{ color: '#fbb03b', textDecoration: 'underline' }}>นโยบายความเป็นส่วนตัว</a>
      </p>
