...
export default async function HomePage() {
  ...
  const lineUrl = settings?.lineUrl || 'https://line.me/R/ti/p/@ubb9405u'
        ...
        <div className="prefooter-cta-buttons">
          <a href={`tel:${phoneRaw}`} className="cta-big cta-call cta-pulse">
            ...
            <span className="cta-big-text">
              <strong>{safeStr(homeCms?.ctaCallText, 'Call หาเราทันที')}</strong>
              <span className="cta-blink-text">{safeStr(homeCms?.ctaCallSub, 'Click เลย !!!')}</span>
            </span>
          </a>
          <a href={lineUrl} target="_blank" rel="noopener noreferrer" className="cta-big cta-line-big cta-pulse">
            <span className="cta-big-icon">
            ...
            <span className="cta-big-text">
              <strong>{safeStr(homeCms?.ctaLineText, 'LINE ปรึกษาฟรี')}</strong>
          ...
          <a href={`https://mail.google.com/mail/?view=cm&to=${email}`} target="_blank" rel="noopener noreferrer" className="cta-big cta-email cta-pulse">
            ...
            <span className="cta-big-text">
              <strong>{safeStr(homeCms?.ctaEmailText, 'Email สอบถาม')}</strong>
              <span className="cta-blink-text">{safeStr(homeCms?.ctaEmailSub, 'Click เลย !!!')}</span>
            </span>
          </a>
        </div>
      </section>
