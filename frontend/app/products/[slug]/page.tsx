...
const styles = `
  ...
  .cat-product-img { height: 200px; background: linear-gradient(135deg, #f0f7ff, #e8f0fe); display: flex; align-items: center; justify-content: center; font-size: 1.2rem; font-weight: 800; color: #003366; letter-spacing: 1px; overflow: hidden; padding: 12px; }
