      ...
      <div className="container">
        <div className="map-section">
          <div style={{ textAlign: 'center', marginBottom: 16 }}>
            <a href="https://maps.app.goo.gl/eiNSyf1Rqcwnh58M7" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '10px 24px', background: '#4285f4', color: '#fff', borderRadius: 50, fontWeight: 700, fontSize: '0.95rem', textDecoration: 'none' }}>
