...
const defaults: ContactInfo = {
  ...
  addressUrl: 'https://maps.app.goo.gl/ovpmCTPfoeTeNRwV8',
...
export default function ContactPage({ cms = {} }: { cms?: ContactInfo }) {
  const info = { ...defaults, ...Object.fromEntries(Object.entries(cms).filter(([, v]) => v)) }
      ...
      <section className="contact-hero">
        <div className="container">
          ...
          <div className="quick-ribbon">
            ...
            <a href={`https://mail.google.com/mail/?view=cm&to=${info.email}`} target="_blank" rel="noopener noreferrer" className="ribbon-btn email">{info.email}</a>
          </div>
        </div>
      </section>
        ...
        <div className="contact-grid">
          <div className="contact-info-cards">
            ...
            <div className="contact-card">
              ...
              <div><h3>ที่อยู่</h3><p><a href={info.addressUrl} target="_blank" rel="noopener noreferrer">{info.address}</a></p></div>
            </div>
            <div className="contact-card">
